...
import com.android.Samkoonhmi.skenum.PLC_RAM_TRANS_TYPE;
...
public class RecipeDataProp {
	...
	public class recipeOGprop{
		...
		/* 配方元素名称列表，sElemNameList.get(0)是元素1的所有语言集合，sElemNameList.get(0).get(0)是元素1的第一种语言的名称*/
		...
		public recipeOGprop copyGroupRecipe()
		{
			...
			{
				mNewGroup.mRecipePropList.add(this.getmRecipePropList().get(i).copyRecipe());
			}
