...
static const char *TAG="LIBSOCKETCAN";
#define LOGI(fmt, args...) __android_log_print(ANDROID_LOG_INFO,  TAG, fmt, ##args)
#define LOGD(fmt, args...) __android_log_print(ANDROID_LOG_DEBUG, TAG, fmt, ##args)
#define LOGE(fmt, args...) __android_log_print(ANDROID_LOG_ERROR, TAG, fmt, ##args)

#define perror(args) LOGE(args)

#define fprintf(fmt, args...)	(fmt==stderr ? LOGE(args):LOGI(args))
...
extern int devicesindex;

#ifndef _Included_Samkoonhmi_Libsocketcan_Interface
#define _Included_Samkoonhmi_Libsocketcan_Interface
